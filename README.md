...
Si vous voulez installer vous-même les dépendances, téléchargez MSVC / Qt / Hunspell / openssl et zlib.  
Pour MSVC et Qt, ils doivent simplement être dans le PATH. Qt a besoin du module QtWebEngine.  
Pour les bibliothèques, les DLL d'openssl doivent être dans openssl/bin, les fichiers d'Hunspell et zlib dans hunspell/lib / hunspell/include et zlib/lib / zlib/include respectivement. Ces chemins sont relatifs à la racine du projet.
